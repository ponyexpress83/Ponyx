...
const steps = [
  {
    number: "01",
    title: "VALIDATE",
    description: "AI scores your idea against real market data in minutes. Get a validation score, competitive analysis, and pricing assessment.",
  ...
  },
  {
    number: "02",
    title: "BUILD",
    description: "Instant MVP generation: landing pages, marketing copy, product architecture — zero coding required.",
  ...
  },
  {
    number: "03",
    title: "TEST",
    description: "Real users, real feedback, real signals in 72 hours. AI plans your go-to-market and acquires first users.",
  ...
  },
  {
    number: "04",
    title: "RAISE",
    description: "Investor-ready pitch deck, financial projections, and data room — generated automatically from your traction data.",
